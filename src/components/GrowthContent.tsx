    ...
    <section className="growth-content" aria-label="微信聊天截图制作指南">
      ...
      <div className="growth-section guide-section" id="guide">
        <div className="growth-heading">
          <div>
            ...
            <h2>三步生成清晰的微信聊天截图</h2>
            <p>无需注册和安装软件，整个制作过程都在当前浏览器中完成。</p>
          </div>
        </div>
      ...
      <div className="growth-section trust-section">
        <div className="trust-copy">
          ...
          <h2>聊天内容不需要离开你的设备</h2>
          <p>对话解析、头像处理和图片生成均在浏览器本地完成。没有弹窗广告，不要求登录，也不会上传聊天内容和生成图片。</p>
      ...
      <div className="growth-section faq-section" id="faq">
        ...
        <div className="faq-grid">
          <details><summary>需要下载软件或注册账号吗？</summary><p>不需要。打开页面即可制作和导出图片，当前功能可以直接免费使用。</p></details>
      ...
      <div className="growth-footer">
        <span><Download size={15} /> 免费使用 · 无弹窗广告</span>
